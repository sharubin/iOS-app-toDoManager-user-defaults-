...
class TaskTypeController: UITableViewController {
    ...
    //2) коллекции доступных типов задач с их описанием
    private var taskTypesInformation: [TypeCellDescription] = [
        (type: .important, title: "Важная", description: "Такой тип задач является наиоболее приоритетным для выполнения. Все важные задачи выводятся в самом верху в списке выполнения"),
    ...
    override func viewDidLoad() {
        ...
        //1) получение значения типа UINib, соответсующее xib-файлу кастомной ячейки
